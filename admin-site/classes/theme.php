...
use BouldersCookbook\CustomPostType as CPT;
use BouldersCookbook\CustomTaxonomy as CTX;
use BouldersCookbook\CustomEndpoint as CEP;

require_once __DIR__ . '/../keys.php';

class BouldersCookbookAdminTheme
{
  ...
  function custom_post_types() {
    new CPT('Recipe', 'Recipes', 'dashicons-carrot', 20, true, ['author']);
  }
